...
function PureSuggestedActions({
  ...
  return (
    <div className="mt-20">
      ...
      >
        <div className="w-32 h-0.5 bg-amber-600/50 mx-auto mb-6" />
          ...
          >
            ...
            >
              <div className="space-y-4">
                ...
                <div className="w-full h-px bg-amber-600/20 group-hover:bg-amber-500/30 transition-colors duration-300" />
