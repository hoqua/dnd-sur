  ...
  return (
    <>
      <div className="flex h-screen bg-black text-white">
        {/* Game-style Sidebar */}
        <div className="w-80 border-r border-amber-600/30 p-6 shrink-0 bg-gradient-to-b from-slate-900 via-slate-800 to-black shadow-2xl">
        ...
        <div className="flex flex-col min-w-0 flex-1 bg-gradient-to-b from-slate-900 via-slate-800 to-black h-screen">
          ...
          <div className="bg-slate-900/90 backdrop-blur shrink-0">
